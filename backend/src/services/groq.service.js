...
- STRICTLY NO explanations, just the JSON object`;
  ...
  const systemPrompt = isRemix
    ? `You are a professional presentation designer redesigning an existing presentation. The user message contains the existing presentation as a compact outline.

Redesign rules:
- Keep the SAME number of slides.
- Preserve the core meaning and information of every slide's content.
- Re-express the copy in a fresh, sharper way (same ideas, new wording).
